...
TOOLSETS = {
    ...
    "symposa-workspace": {
        "description": "Symposa company users — files, web, documents, images, scheduling",
        "tools": [
            "read_file",
            "write_file",
            "patch",
    ...
    "symposa-web": {
        "description": "Symposa web/API workplace — hermes-api-server plus clarify, without coding subagents",
        "tools": [
            # Web
            "web_search", "web_extract",
            # Terminal + process management
            ...
            # Home Assistant smart home control (gated on HASS_TOKEN via check_fn)
            "ha_list_entities", "ha_get_state", "ha_list_services", "ha_call_service",
            # Interactive clarify (Symposa web UI resolves via SSE + POST clarify)
            "clarify",
        ],
        "includes": [],
    },
